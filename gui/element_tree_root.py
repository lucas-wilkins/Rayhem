from PySide6.QtWidgets import QTreeWidgetItem, QWidget, QGridLayout, QLabel, QCheckBox
...
from gui.reuse.spinboxes import MagnitudeSpinBox, SpatialSpinBox, DistanceSpinBox
